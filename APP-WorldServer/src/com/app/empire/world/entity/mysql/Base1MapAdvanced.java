...
/**
 * Base1MapAdvanced entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "base1_map_advanced", catalog = "game3")
public class Base1MapAdvanced implements java.io.Serializable {
	...
	/** default constructor */
	public Base1MapAdvanced() {
	}

	/** full constructor */
	public Base1MapAdvanced(Integer id, Integer mapCopyId, String name,
			Integer showId, Integer sceneId, Integer packId, Integer CUserLv,
			Integer CEnergyA, Integer CEnergyB, Integer CGold,
			Integer OPassCondition, Integer ONum, Integer OTime, String AGold,
			Integer AExperience, Integer sum, String starType, Integer mapLv,
			Integer monsterLv, String showMonster, Integer status,
			String descript, String info, String expGoodsId,
			Integer monsterStar, Integer monsterQuality, String firstDrop) {
		this.id = id;
	...
	@Column(name = "star_type", nullable = false, length = 20)
	...
	@Column(name = "exp_goods_id", nullable = false, length = 126)
