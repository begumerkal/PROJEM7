...
/**
 * Base1MapCopyGuild entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "base1_map_copy_guild", catalog = "game3")
public class Base1MapCopyGuild implements java.io.Serializable {
	...
	/** default constructor */
	public Base1MapCopyGuild() {
	}

	/** full constructor */
	public Base1MapCopyGuild(Integer id, String name, String last, String next,
			Integer showId, Integer sceneId, Integer CUserLv, Integer CEnergyA,
	...
	@Column(name = "next", nullable = false, length = 50)
