...
/**
 * CIpId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class CIpId implements java.io.Serializable {
	...
	/** full constructor */
	public CIpId(Integer ip, Integer type, Integer time1, Integer time2) {
		this.ip = ip;
		this.type = type;
		this.time1 = time1;
		this.time2 = time2;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CIpId))
			return false;
		CIpId castOther = (CIpId) other;
