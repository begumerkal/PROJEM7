package com.wyd.exchange.utils;
...
//    }
    ...
    public static Timestamp stringToDate(String strDate) {
        ...
        try {
            if (strDate != null && !strDate.equals("")) {
                timestamp = new java.sql.Timestamp(parse(strDate).getTime());
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    //获取当前日期前几天或者后几天的日期   
    public static Timestamp afterNowNDay(int n) {
        Calendar c = Calendar.getInstance();
    ...
    public static void main(String[] s) {
        ...
        System.out.println(DateUtil.format(DateUtil.nowTimestamp()));
