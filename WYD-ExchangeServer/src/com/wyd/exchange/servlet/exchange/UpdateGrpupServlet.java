 ...
 * @author zgq
 */
public class UpdateGrpupServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            GroupExchange groupExchange = (GroupExchange) ServiceManager.getManager().getExchangeService().get(GroupExchange.class, groupInfo.getId());
            if (null != groupExchange) {
                groupExchange.setServices(groupInfo.getServices());
                groupExchange.setRemark(groupInfo.getRemark());
                ServiceManager.getManager().getExchangeService().update(groupExchange);
                ret = "success";
            }
        } catch (Exception e) {
            e.printStackTrace();
