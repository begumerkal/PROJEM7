 ...
 * @author zguoqiu
 */
public class GetTopThirtyListServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            List<Integral> integralList = ServiceManager.getManager().getIntegralService().getIntegralRank(goupId, 30);
