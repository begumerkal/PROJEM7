 ...
 */
@Entity()
@Table(name = "tab_group_exchange")
public class GroupExchange implements Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof GroupExchange)) {
            return false;
        }
        GroupExchange castOther = (GroupExchange) other;
