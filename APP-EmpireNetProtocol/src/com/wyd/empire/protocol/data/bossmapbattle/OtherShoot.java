...
public class OtherShoot extends AbstractData {
	...
	public OtherShoot(int sessionId, int serial) {
		super(Protocol.MAIN_BOSSMAPBATTLE, Protocol.BOSSMAPBATTLE_OtherShoot, sessionId, serial);
	}

	public OtherShoot() {
		super(Protocol.MAIN_BOSSMAPBATTLE, Protocol.BOSSMAPBATTLE_OtherShoot);
	}
