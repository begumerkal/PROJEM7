...
public class UpdateMedal extends AbstractData {
	...
	public UpdateMedal(int sessionId, int serial) {
		super(Protocol.MAIN_BOSSMAPBATTLE, Protocol.BOSSMAPBATTLE_UpdateMedal, sessionId, serial);
	}

	public UpdateMedal() {
		super(Protocol.MAIN_BOSSMAPBATTLE, Protocol.BOSSMAPBATTLE_UpdateMedal);
	}
