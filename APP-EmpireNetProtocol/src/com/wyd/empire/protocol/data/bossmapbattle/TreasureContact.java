...
public class TreasureContact extends AbstractData {
	...
	public TreasureContact(int sessionId, int serial) {
		super(Protocol.MAIN_BOSSMAPBATTLE, Protocol.BOSSMAPBATTLE_TreasureContact, sessionId, serial);
	}

	public TreasureContact() {
		super(Protocol.MAIN_BOSSMAPBATTLE, Protocol.BOSSMAPBATTLE_TreasureContact);
	}
