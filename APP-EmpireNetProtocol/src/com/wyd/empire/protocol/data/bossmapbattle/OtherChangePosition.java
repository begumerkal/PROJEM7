...
public class OtherChangePosition extends AbstractData {
    ...
    public OtherChangePosition(int sessionId, int serial) {
        super(Protocol.MAIN_BOSSMAPBATTLE, Protocol.BOSSMAPBATTLE_OtherChangePosition, sessionId, serial);
    }

    public OtherChangePosition() {
        super(Protocol.MAIN_BOSSMAPBATTLE, Protocol.BOSSMAPBATTLE_OtherChangePosition);
    }
