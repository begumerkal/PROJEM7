...
public class CrossSynPlayerInfo extends CrossDate {
    private int      roomId;
    ...
    private int[]    sourcePlayerId;     // 玩家原服的角色id
    private String[] serverId;           // 玩家所在的服务器id
    private String[] serverName;         // 玩家所在游戏分区名
    ...
    public CrossSynPlayerInfo() {
        super(Protocol.MAIN_CROSS, Protocol.CROSS_CrossSynPlayerInfo);
    }
