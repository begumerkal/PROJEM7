...
public class GetPlayerInfoOk extends AbstractData {
	private int id; 				// Id
	...
	public GetPlayerInfoOk(int sessionId, int serial) {
		super(Protocol.MAIN_PLAYER, Protocol.PLAYER_GetPlayerInfoOk, sessionId, serial);
	}

	public GetPlayerInfoOk() {
		super(Protocol.MAIN_PLAYER, Protocol.PLAYER_GetPlayerInfoOk);
	}
