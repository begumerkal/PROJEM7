 ...
 * @author zhaopeilong
 */
public class BuyResult extends AbstractData {
    ...
    public BuyResult(int sessionId, int serial) {
        super(Protocol.MAIN_TRATE, Protocol.TRATE_BuyResult, sessionId, serial);
    }

    public BuyResult() {
        super(Protocol.MAIN_TRATE, Protocol.TRATE_BuyResult);
    }
