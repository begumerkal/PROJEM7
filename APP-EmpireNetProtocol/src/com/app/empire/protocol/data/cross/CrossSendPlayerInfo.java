...
public class CrossSendPlayerInfo extends AbstractData {
    private int       roomId;
    ...
    private int[]     playerWeaponSkillCount; // 玩家的武器技能数量
    ...
    private boolean[] robot;                 // 宠物参数2
    private String    serverName;            // 游戏分区名
    ...
    public CrossSendPlayerInfo() {
        super(Protocol.MAIN_CROSS, Protocol.CROSS_CrossSendPlayerInfo);
    }
    ...
    public int[] getPlayerWeaponSkillCount() {
        return playerWeaponSkillCount;
    }

    public void setPlayerWeaponSkillCount(int[] playerWeaponSkillCount) {
        this.playerWeaponSkillCount = playerWeaponSkillCount;
    }
