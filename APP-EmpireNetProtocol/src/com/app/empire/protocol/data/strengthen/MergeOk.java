...
public class MergeOk extends AbstractData {
    ...
    public MergeOk(int sessionId, int serial) {
        super(Protocol.MAIN_STRENGTHEN, Protocol.STRENGTHEN_MergeOk, sessionId, serial);
    }

    public MergeOk() {
        super(Protocol.MAIN_STRENGTHEN, Protocol.STRENGTHEN_MergeOk);
    }
