...
public class Access_VTC {
	...
	private static final String LOGOUT_URL = "http://test.account.ombom.goplay.vn/Logout/";
	...
	public LoginResult getUserLoginResult(ChannelInfo_VTC channelInfo) {
		...
		String parameterJosnStr = channelInfo.getParameter()[1];//第一个位置是userid
	...
	public void logout(String userid, String username, int roleid, String rolename, int serverid, int level) {
		...
		String reqUrl = LOGOUT_URL + "?userid=" + userid + "&username=" + username + "&serverid=" + serverid + "&roleid=" + roleid + "&rolename=" + rolename + "&level=" + level;
		HttpClient client = new HttpClient();
