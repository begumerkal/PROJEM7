...
import com.wyd.empire.world.dao.IPracticeDao;
import com.wyd.empire.world.server.service.base.IPracticeService;

/**
 * The service class for the TabConsortiaright entity.
 */
public class PracticeService extends UniversalManagerImpl implements IPracticeService {
	Logger log = Logger.getLogger(PracticeService.class);
	/**
	 * The dao instance injected by Spring.
	 */
	private IPracticeDao dao;
	/**
	 * The service Spring bean id, used in the applicationContext.xml file.
	 */
	private static final String SERVICE_BEAN_ID = "PracticeService";
	 ...
	 */
	public static IPracticeService getInstance(ApplicationContext context) {
		return (IPracticeService) context.getBean(SERVICE_BEAN_ID);
	}
	 ...
	 */
	public void setDao(IPracticeDao dao) {
		super.setDao(dao);
		this.dao = dao;
	}

	public IPracticeDao getDao() {
		return this.dao;
	}
	...
	public List<Practice> getAllPractice() {
		return dao.getAll(Practice.class);
	}
	...
	// * @param dateTime 时间日期
	// * @param playerId 玩家ID
	// * @param activityName 为空则不发奖励
	// * @return
	// */
	// public boolean isSend(String dateTime, int playerId,String activityName)
	// {
	// if(!StringUtils.hasText(activityName))return true;
