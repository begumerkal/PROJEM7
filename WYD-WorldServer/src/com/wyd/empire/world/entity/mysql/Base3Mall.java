 ...
 */
@Entity
@Table(name = "base3_mall", catalog = "game3")
public class Base3Mall implements java.io.Serializable {
	...
	/** full constructor */
	public Base3Mall(Integer id, Integer mallType, Integer sort,
			Integer goodsExtId, Boolean type, Integer money, Integer moneyType,
			Integer sum, Integer stintSum, Integer colour, Integer lv,
			String randP, Float rebate, Integer status) {
		this.id = id;
