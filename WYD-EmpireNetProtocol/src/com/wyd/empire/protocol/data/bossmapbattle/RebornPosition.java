...
public class RebornPosition extends AbstractData {
	...
	public RebornPosition(int sessionId, int serial) {
		super(Protocol.MAIN_BOSSMAPBATTLE, Protocol.BOSSMAPBATTLE_RebornPosition, sessionId, serial);
	}

	public RebornPosition() {
		super(Protocol.MAIN_BOSSMAPBATTLE, Protocol.BOSSMAPBATTLE_RebornPosition);
	}
