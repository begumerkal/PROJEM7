...
public class OtherFly extends AbstractData {
	...
	public OtherFly(int sessionId, int serial) {
		super(Protocol.MAIN_BOSSMAPBATTLE, Protocol.BOSSMAPBATTLE_OtherFly, sessionId, serial);
	}

	public OtherFly() {
		super(Protocol.MAIN_BOSSMAPBATTLE, Protocol.BOSSMAPBATTLE_OtherFly);
	}
