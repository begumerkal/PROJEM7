...
public class SendPlayerBattleAttribute extends AbstractData {
	...
	public SendPlayerBattleAttribute(int sessionId, int serial) {
		super(Protocol.MAIN_BATTLE, Protocol.BATTLE_SendPlayerBattleAttribute, sessionId, serial);
	}

	public SendPlayerBattleAttribute() {
		super(Protocol.MAIN_BATTLE, Protocol.BATTLE_SendPlayerBattleAttribute);
	}
