...
public class SendRoleActorList extends AbstractData {
    ...
    public SendRoleActorList(int sessionId, int serial) {
        super(Protocol.MAIN_ACCOUNT, Protocol.ACCOUNT_SendRoleActorList, sessionId, serial);
    }

    public SendRoleActorList() {
        super(Protocol.MAIN_ACCOUNT, Protocol.ACCOUNT_SendRoleActorList);
    }
