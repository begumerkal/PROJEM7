 ...
 *
 */
public class PlayerPet extends AbstractData {
    ...
    private int[]     trainAddLevel;         // 训练完成增加的级别
    private int[]     skillId;               // 宠物技能ID
	
	
	public PlayerPet(int sessionId, int serial) {
		super(Protocol.MAIN_CACHE, Protocol.CACHE_PlayerPet, sessionId, serial);
	}

	public PlayerPet() {
		super(Protocol.MAIN_CACHE, Protocol.CACHE_PlayerPet);
	}
