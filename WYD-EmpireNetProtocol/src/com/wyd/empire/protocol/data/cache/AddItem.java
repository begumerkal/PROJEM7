...
public class AddItem  extends AbstractData {
	...
	public AddItem(int sessionId, int serial) {
		super(Protocol.MAIN_CACHE, Protocol.CACHE_AddItem, sessionId, serial);
	}

	public AddItem() {
		super(Protocol.MAIN_CACHE, Protocol.CACHE_AddItem);
