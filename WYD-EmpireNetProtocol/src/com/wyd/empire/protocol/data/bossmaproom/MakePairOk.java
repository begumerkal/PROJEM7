...
public class MakePairOk extends AbstractData {
    ...
    private int[]    roomId;               // 所有玩家所在房间id(AI填零)
    ...
    public MakePairOk(int sessionId, int serial) {
        super(Protocol.MAIN_BOSSMAPROOM, Protocol.BOSSMAPROOM_MakePairOk, sessionId, serial);
    }

    public MakePairOk() {
        super(Protocol.MAIN_BOSSMAPROOM, Protocol.BOSSMAPROOM_MakePairOk);
    }
