...
public class ChangePropOk extends AbstractData {
	...
	public ChangePropOk(int sessionId, int serial) {
		super(Protocol.MAIN_PLAYER, Protocol.PLAYER_ChangePropOk, sessionId, serial);
	}

	public ChangePropOk() {
		super(Protocol.MAIN_PLAYER, Protocol.PLAYER_ChangePropOk);
	}
