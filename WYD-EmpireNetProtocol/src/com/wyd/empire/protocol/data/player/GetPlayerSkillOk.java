...
/**
 * 类 <code>GetPlayerSkillOk</code>继承抽象类<code>AbstractData</code>，实现接口主命令Protocol.MAIN_PLAYER下子命令PLAYER_GetPlayerSkillOk(获取玩家技能成功列表)对应数据封装。
 * 
 * @see AbstractData
 * @author zhaopeilong
 */
public class GetPlayerSkillOk extends AbstractData {
    ...
    public GetPlayerSkillOk(int sessionId, int serial) {
        super(Protocol.MAIN_PLAYER, Protocol.PLAYER_GetPlayerSkillOk, sessionId, serial);
    }

    public GetPlayerSkillOk() {
        super(Protocol.MAIN_PLAYER, Protocol.PLAYER_GetPlayerSkillOk);
    }
