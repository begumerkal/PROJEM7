...
public class ChangeSkillOk extends AbstractData {
	...
	public ChangeSkillOk(int sessionId, int serial) {
		super(Protocol.MAIN_PLAYER, Protocol.PLAYER_ChangeSkillOk, sessionId, serial);
	}

	public ChangeSkillOk() {
		super(Protocol.MAIN_PLAYER, Protocol.PLAYER_ChangeSkillOk);
	}
