...
/**
 * 类 <code>GetPlayerPropOk</code>继承抽象类<code>AbstractData</code>，实现接口主命令Protocol.MAIN_PLAYER下子命令PLAYER_GetPlayerPropOk(获取玩家道具成功列表)对应数据封装。
 * 
 * @see AbstractData
 * @author zhaopeilong
 */
public class GetPlayerPropOk extends AbstractData {
    ...
    public GetPlayerPropOk(int sessionId, int serial) {
        super(Protocol.MAIN_PLAYER, Protocol.PLAYER_GetPlayerPropOk, sessionId, serial);
    }

    public GetPlayerPropOk() {
        super(Protocol.MAIN_PLAYER, Protocol.PLAYER_GetPlayerPropOk);
    }
