...
/**
 * 类 <code>GetPropListOk</code>继承抽象类<code>AbstractData</code>，实现接口主命令Protocol.MAIN_PLAYER下子命令PLAYER_GetPropListOk(获取道具成功列表)对应数据封装。
 * 
 * @see AbstractData
 * @author zhaopeilong
 */
public class GetPropListOk extends AbstractData {
    ...
    public GetPropListOk(int sessionId, int serial) {
        super(Protocol.MAIN_PLAYER, Protocol.PLAYER_GetPropListOk, sessionId, serial);
    }

    public GetPropListOk() {
        super(Protocol.MAIN_PLAYER, Protocol.PLAYER_GetPropListOk);
    }
