...
public class GetRateListOk extends AbstractData {
    /** 强化等级 */
    private int[]    rateId;
    /** 强化消耗金币 */
    ...
    private int      strongeTopLevel; // 强化最高等级

    public GetRateListOk(int sessionId, int serial) {
        super(Protocol.MAIN_STRENGTHEN, Protocol.STRENGTHEN_GetRateListOk, sessionId, serial);
    }

    public GetRateListOk() {
        super(Protocol.MAIN_STRENGTHEN, Protocol.STRENGTHEN_GetRateListOk);
    }
    ...
    public int getStrongeTopLevel() {
        return strongeTopLevel;
    }

    public void setStrongeTopLevel(int strongeTopLevel) {
        this.strongeTopLevel = strongeTopLevel;
    }
}
